        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Friendships_Status", "Status IN ('Pending', 'Accepted', 'Declined', 'Blocked')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Stories_ContentType", "ContentType IN ('Text', 'Image')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentRoom = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GroupMembers_Role", "Role IN ('Admin', 'Member')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverGroupId = table.Column<int>(type: "INTEGER", nullable: true),
                    Content = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Messages_MessageType", "MessageType IN ('Text', 'Image', 'Video', 'File', 'Voice')");
                    table.CheckConstraint("CK_Messages_ReceiverCheck", "ReceiverUserId IS NOT NULL OR ReceiverGroupId IS NOT NULL");
                    table.CheckConstraint("CK_Messages_Status", "Status IN ('Sent', 'Delivered', 'Read')");
                    table.ForeignKey(
